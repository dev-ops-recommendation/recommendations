...
class TestRecommendationModel(unittest.TestCase):
    ...
    def test_create_a_recommendation(self):
        ...
        recommendation = Recommendation(
            product_id=1, recommendation_product_id=2, relationship=Type.UP_SELL
        )
    ...
    def test_serialize_a_recommendation(self):
        ...
        self.assertEqual(
            data["recommendation_product_id"], recommendation.recommendation_product_id
        )
    ...
    def test_find_recommendation_type(self):
        ...
        recommendation = Recommendation.find(
            recommendations[1].product_id, recommendations[1].recommendation_product_id
        )
        self.assertIsNot(recommendation, None)
        self.assertEqual(recommendation.product_id, recommendations[1].product_id)
        self.assertEqual(
            recommendation.recommendation_product_id,
            recommendations[1].recommendation_product_id,
        )
    ...
    def test_find_recommendation_by_id_and_type(self):
        ...
        recommendations = [
            ...
            Recommendation(
                product_id=query_id,
                recommendation_product_id=15,
                relationship=Type.ACCESSORY,
            ),
        ]
