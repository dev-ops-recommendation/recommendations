...
def create_recommendations():
    ...
    try:
        ...
        raise BadRequest(
            "Cannot create relationship between product {} and {}".format(
    ...
    location_url = url_for(
        ...
        recommendation_product_id=recommendation.recommendation_product_id,
        _external=True,
    )
...
######################################################################
@app.route(
    "/recommendations/<int:product_id>/recommended-products/<int:recommendation_product_id>",
    methods=["GET"],
)
def get_recommendations(product_id, recommendation_product_id):
    ...
    """
    app.logger.info(
        "Request for relationship between product ids: %s %s",
        product_id,
    ...
    if not recommendation:
        raise NotFound(
            "Recommendation for product id {} and {} was not found.".format(
...
######################################################################
@app.route(
    "/recommendations/<int:product_id>/recommended-products/<int:recommendation_product_id>/like",
    methods=["PUT"],
)
def like_recommendations(product_id, recommendation_product_id):
    ...
    """
    app.logger.info(
        "Request to like a recommendation between %s and %s",
        product_id,
        recommendation_product_id,
    )
    recommendation = Recommendation.find(product_id, recommendation_product_id)
...
######################################################################
@app.route(
    "/recommendations/<int:product_id>/recommended-products/<int:recommendation_product_id>/dislike",
    methods=["PUT"],
)
def dislike_recommendations(product_id, recommendation_product_id):
    """
    dislike a relationship
    """
    app.logger.info(
        "Request to dislike a recommendation between %s and %s",
        product_id,
        recommendation_product_id,
    )
    recommendation = Recommendation.find(product_id, recommendation_product_id)
...
# DISLIKE A RECOMMENDATION 
######################################################################
@app.route("/recommendations/<int:product_id>/recommended-products/<int:recommendation_product_id>/dislike", methods=["PUT"])
def dislike_recommendations(product_id, recommendation_product_id):
    """
    like a relationship
    """
...
def delete_recommendations(product_id, recommendation_product_id):
    ...
    """
    app.logger.info(
        "Request to delete relationship between product ids: %s %s",
        product_id,
        recommendation_product_id,
    )
    recommendation = Recommendation.find(product_id, recommendation_product_id)
...
def query_recommendations(product_id):
    ...
    app.logger.info(
        "Request for recommendations query for id %s and type %s", product_id, type
    )
